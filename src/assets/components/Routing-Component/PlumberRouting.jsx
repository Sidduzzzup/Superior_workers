...
const PlumberRouting = () => {
  ...
  const handleBookNow = () => {
   ...
   return (<>
       ...
       <div>
         <img className="h-[350px] md:h-[400px] md:absolute md:top-28" src= "/pngfind.com-construction-worker-png-1649001.png"  alt="Plumber" />
       </div>
       <div>
      <motion.div 
       ...
       className="space-y-4 p-6 text-center max-w-[600px] mx-auto mb-5">
           ...
           <p className="font-semibold text-xl md:text-3xl">
            We Have Highly Experienced Plumbers in INDIA
           </p>
