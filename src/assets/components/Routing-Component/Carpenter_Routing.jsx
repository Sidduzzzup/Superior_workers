...
const Carpenter_Routing = () => {
  return (<>
      ...
      <div className="ml-14">
        <img className="h-[400px] absolute top-28" src= "./public/pngfind.com-construction-worker-png-3160821.png"  alt="Plumber" />
      </div>
      <div>
      <motion.div 
      ...
      className="space-y-4 p-6 text-center max-w-[600px] mx-auto mb-5">
          ...
          Need carpentry services for your home? From furniture repairs to custom woodworking, our
